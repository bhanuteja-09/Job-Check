                ...
                <Box paddingTop={4} paddingBottom={6}>
                    <div className="buttons col-xs-12">
                        <Grid container >
                            ...
                            <Grid items>
                                <Button style={{ marginLeft: '20px' }} color='secondary' variant='contained' onClick={() => { handleEnable() }}>Create Subscription</Button>
                            </Grid>
                        </Grid>
                    </div>
                    ...
                    >
                        <Box sx={{ ...style, width: 420, height: 300, borderRadius: 2 }}>
                            ...
                            <Grid container>
                                ...
                                <Grid item className='mains'>
                                    <Button color='secondary' variant='contained' type='submit' onClick={handleSubmit} >Create</Button>
                                </Grid>
                            </Grid>
                        </Box>
                    </Modal>
