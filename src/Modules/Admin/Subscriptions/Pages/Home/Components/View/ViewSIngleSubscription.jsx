...
import { Button, Container, FormControl, IconButton, Input, MenuItem, Select, Switch, TextField } from '@mui/material';
import { Modal } from '@mui/material';
import { Grid } from '@mui/material';
import Typography from '@mui/material/Typography';
import { addUsers, getSingleUser, updateSingleUser } from '../../Actions/Action';
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Box>
                        ...
                        <Grid container >
                                ...
                                >
                                    ...
                                    <Box>
                                        <TextField
                                            ...
                                            onChange={(e) => setState({ ...state, Subscription: e.target.value })}
                                            variant="outlined"
                                            size="small"
                                            margin="dense"
                                            fullWidth
                            ...
                            <Grid item sx={{ marginLeft: '70%' }}>
                                ...
                                <img style={{ marginLeft: '22%' }} src={Capture22} alt="logoImage" />
                                <div >
                                    <Box sx={{ ...commonStyles }}>
                                        <label htmlFor="icon-button-file">
                                            <Input disabled={isdisabled} accept="image/*" id="icon-button-file" type="file" />

                                            <CloudUploadIcon sx={{ color: 'blueviolet' }} />
                                        </label>
                                        <Typography variant="body2" gutterBottom fontWeight={'600'}>
                                            <span style={{ color: 'blueviolet' }}>Click to upload </span>or drag and drop<br /> SVG,PNG,JPG or GIF()
                                        </Typography>
                                    </Box>
                                </div>
                            </Grid>
                        ...
                        >
                            <Box>
                                ...
                                <TextField
                                    ...
                                    type="number"
                                    name="BaseCredits"
                                    onChange={(e) => setState({ ...state, BaseCredits: e.target.value })}
                                    size="small"
                                    margin="dense"
                                    fullWidth
                                />
                                ...
                                ><Grid item>
                                        <Box>
                                            ...
                                            <Select
                                                disabled={isdisabled}
                                                value={state.Pricing || ""}
                                                onChange={(e) => setState({ ...state, Pricing: e.target.value })}
                                                label="Pricing"
                                                fullWidth
                                                size="small"
                                                margin="dense"
                    ...
                    <Grid container>
                        <Switch
                            ...
                            onChange={(e) => setState({ ...state, Status: true ? "Active" : "In Active" })}
                    ...
                    <div>
                        ...
                        <Button variant='outlined' href='/SearchSubscription'>Close</Button>
                        ...
                        <Box sx={{ ...style, width: 400, height: 300, borderRadius: 2 }}>
                            ...
                            <Grid container>
                                ...
                                <Grid item sx={{
                                    ...
                                    <Button color='secondary' variant='contained' type='submit' onClick={handleSubmit} >Update</Button>
                                </Grid>
                            </Grid>
                        </Box>
                    </Modal>
