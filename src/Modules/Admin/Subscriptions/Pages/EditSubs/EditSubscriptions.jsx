...
import { Button, Container, FormControl, Input, MenuItem, Select, Switch, TextField } from '@mui/material';
...
import { addUsers, getSingleUser, updateSingleUser } from '../Home/Actions/Action';
            ...
            <Box className='main' >
                <form onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <Button style={{ marginLeft: '20px' }} color='secondary' variant='contained' onClick={() => { handleEnable() }}>Save Changes</Button>
